...
#
# Generated by Vivado on Thu Jan 06 15:27:14 +0800 2022
...
# Script info
echo -e "inst_ram.sh - Script generated by export_simulation (Vivado v2021.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L blk_mem_gen_v8_4_5 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot inst_ram xil_defaultlib.inst_ram xil_defaultlib.glbl -log elaborate.log
}
...
{
  file="xsim.ini"
  lib_map_path="D:/vivado/Vivado/2021.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
